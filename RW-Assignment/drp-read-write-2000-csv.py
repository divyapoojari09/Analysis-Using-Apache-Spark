...
#USING FILTER FUNCTION TO EXTRACT DATA OF YEAR 1920 ONLY

df_2000=df2.filter(df2["Observation_Date"].between('2000-01-01','2000-12-31'))

#df_2000 = df2.filter(col('Observation_Date').contains("2000"))

#df_1920.show(5)

#Writing csv file

df_2000.write.format("csv").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/drp/2000/csv-file")
