...
#Filtering good records
df2_ValidRecords_Press=df2.filter(col("Atmospheric_Pressure") != 9999.9)

#Writing to CSV
df2_ValidRecords_Press.write.format("csv").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/drp/2000/valid-records-press")
