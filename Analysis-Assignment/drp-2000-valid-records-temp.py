...
df2_ValidRecords_Temp=df2.filter(col("Air_Temperature") != 999.9)

#Writing to CSV
df2_ValidRecords_Temp.write.format("csv").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/drp/2000/valid-records-temp")
